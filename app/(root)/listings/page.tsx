  ...
  return (
    <div className="w-full relative">
      ...
      <div className="container flex flex-col gap-4 py-10">
        <div>
          <h4 className="text-lg font-semibold">Popular homes in Lagos</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold">Popular homes in Ibadan</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold">Popular homes in Abuja</h4>
          <ScrollArea className="">
            <div className="flex w-max space-x-4 md:space-x-6 lg:space-x-8 pt-4 pr-10 pb-8">
              {listings.map((listing) => (
                <ListingCard listing={listing} key={listing.id} />
