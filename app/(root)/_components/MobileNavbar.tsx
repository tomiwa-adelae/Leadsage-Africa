          ...
          <div className="container pb-20">
            <div className="flex flex-1 flex-col overflow-x-hidden">
                ...
                {navLinks.map(({ label, slug }, idx) => (
                  <Link
                    ...
                    className={`group flex items-center justify-start gap-2 group/sidebar
                            ...
                            } hover:bg-[#F2F2F2] dark:bg-muted/20 p-4 rounded-lg
                            `}
                    onClick={handleClick}
                  >
              ...
              <div className="flex flex-col mt-4 w-full items-center justify-end gap-4">
                <SheetClose asChild>
                  <Button asChild size="md" className="text-sm w-full">
                    <Link href="/listings">Rent an apartment</Link>
                  </Button>
                </SheetClose>
                <SheetClose asChild>
                  <Button
                    ...
                    size="md"
                  >
                    <Link href="/sign-up">Become a landlord</Link>
                  </Button>
                </SheetClose>
              </div>
            </div>
