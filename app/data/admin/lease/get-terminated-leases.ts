...
export const getTerminatedLeases = async ({
  query,
  page = 1,
  limit,
}: Params = {}) => {
        ...
        ...(query
          ? {
              OR: [
                ...
                // Note: depositStatus is an enum, so we check if query matches any enum values
...
export type GetTerminatedLeasesType = Awaited<
  ReturnType<typeof getTerminatedLeases>
>["leases"][0];
