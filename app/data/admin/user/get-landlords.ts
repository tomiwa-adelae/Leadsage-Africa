...
export const getLandlords = async ({ query, page = 1, limit }: Params = {}) => {
  await requireAdmin();
  ...
  const [landlords, totalCount] = await Promise.all([
...
export type GetLandlordsType = Awaited<
  ReturnType<typeof getLandlords>
>["landlords"][0];
