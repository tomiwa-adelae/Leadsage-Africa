    ...
    <div>
      ...
      <div className="py-4 md:py-6 px-4 lg:px-6">
        <PageHeader
          ...
          description={"Once our team reviews and approves it, it will go live on the platform for renters to discover. We typically review listings within 20-48 hours."}
        />
