		...
		<div>
			...
			<div className="py-4 md:py-6 px-4 lg:px-6">
				...
				<p className="text-muted-foreground text-base mt-2.5">
					Carefully review all the details you've provided before
					publishing your listing. Make sure everything is accurate.
					This is what potential renters will see.
				</p>
				<div className="mt-8 space-y-4">
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/title`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/description`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new?id=${listingId}`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/location`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/describe`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/amenities`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/photos`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/policies`}
								>
									Edit
								</Link>
							</Button>
					...
					<div>
						<div className="flex items-center justify-between gap-3">
							...
							>
								<Link
									href={`/landlord/listings/new/${listingId}/price`}
								>
									Edit
								</Link>
							</Button>
