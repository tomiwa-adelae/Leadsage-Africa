...
export const adminCancelTourLandlord = ({
  landlordName,
  tenantName,
  location,
  date,
  ...
  <div>
    ...
    <div class="p-10">
      <p class="mb-6 text-gray-700 leading-relaxed">
        ...
        Please be advised that the tour booked by
      ...
      <p class="text-gray-700 leading-relaxed">
        No action is required from your end. If the tenant decides to reschedule, you will be notified.
      </p>
