...
<body class="font-sans bg-gray-100 p-5">
  <div>
    <h1 class="text-2xl font-semibold mb-2 text-red-600">❌ Listing Rejected</h1>
    ...
    <div class="p-10">
      ...
      <div class="bg-red-50 border-l-4 border-red-500 p-5 rounded-r-lg my-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-3">Reason for Rejection</h3>
      ...
      <div class="text-center my-8">
        <a
          ...
          class="inline-block bg-red-600 text-white py-3 px-8 rounded-full font-semibold hover:bg-red-700"
        >
