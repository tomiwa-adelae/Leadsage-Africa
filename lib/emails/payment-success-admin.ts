...
<body class="font-sans bg-gray-100 p-5">
  <div>
    <h1 class="text-2xl font-semibold mb-2 text-green-700">💰 Payment Received</h1>
    ...
    <div class="p-10">
      ...
      <div class="bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-lg my-6">
        ...
        <p class="text-gray-700 m-0"><span class="font-semibold">User:</span> ${userName}</p>
        <p class="text-gray-700 m-0"><span class="font-semibold">Amount:</span> ₦${amount}</p>
        <p class="text-gray-700 m-0"><span class="font-semibold">Property:</span> ${property}</p>
        <p class="text-gray-700 m-0"><span class="font-semibold">Reference ID:</span> ${reference}</p>
      </div>
