...
export const cancelTourTenant = ({ name, location, date, time }: Props) => `
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<body class="font-sans bg-gray-100 p-5">
  <div>
    <div>
      ...
      <p class="opacity-90 m-0">Your property viewing has been canceled</p>
    </div>

    <div class="p-10">
      <p class="mb-6 text-gray-700 leading-relaxed">
        Hi <span class="font-bold">${name}</span>,<br /><br />
        Your scheduled tour for the property at <span class="font-bold">${location}</span> on 
        <strong>${date}</strong> at <strong>${time}</strong> has been successfully canceled.
      </p>

      <p class="text-gray-700 leading-relaxed">
        If you’d like, you can reschedule another time directly from your dashboard.
      </p>
